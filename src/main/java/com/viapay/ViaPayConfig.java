...
public class ViaPayConfig {
     ...
     */
    public static String plat_form;
    /**
     * 默认金额
     */
    ...
    static{
        ...
        InputStream in = ViaPayConfig.class.getResourceAsStream("/viapayconfig.properties");   
        try {   
            prop.load(in);   
            key = prop.getProperty("key").trim();   
            package_id = prop.getProperty("package_id").trim();   
            ...
            plat_form= prop.getProperty("plat_form").trim();  
