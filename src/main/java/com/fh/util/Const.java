...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(upload)|(code)|(app)|(weixin)|(static)|(main)|(index)|(movie)|(wapmovie)|(ylpay)|(wapv2)|(tuku)|(thirdpay)|(viapay)|(alipay)|(bbpay)).*";	//不对匹配该值的访问路径拦截（正则）
