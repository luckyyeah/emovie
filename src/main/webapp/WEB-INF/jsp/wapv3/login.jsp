        ...
        $(".userActive").click(function (e) {
            ...
            if ( orderNo == '') {
                ...
                return false;
								...
								var url = "<%=basePath%>wapv3/checkOrderPayed?CHANNEL_NO=${pd.CHANNEL_NO}&orderNo=" + orderNo +"&uid="+getCookie("uid")+ "&tm="+new Date().getTime();
								$.get(url,function(data){
									if(data=="1"){
										 activeBtn.html("登录成功，页面正在跳转");
										 location.href ="<%=basePath%>wapv3/loadResult/${pd.CHANNEL_NO}";
									} else {
