...
<body>
	...
	<section class="ui-panel" id="movite_content">
		<div class="about">
			...
			<p>3、夜夜快播转载的文字、图片、音视频等资料均由本站用户提供，其真实性、准确性和合法性由信息发布人负责。夜夜快播不提供任何保证，并不承担任何法律责任。</p>
			<p>4、夜夜快播所转载的文字、图片、音视频等资料，如果侵犯了第三方的知识产权或其他权利，责任由作者或转载者本人承担，本站对此不承担责任。</p>
			<details>
				<summary style="text-align: right; color: #225599; font-size: 12px">显示更多</summary>
				<p>5、夜夜快播不保证为向用户提供便利而设置的外部链接的准确性和完整性，同时，对于该外部链接指向的不由夜夜快播实际控制的任何网页上的内容，夜夜快播不承担任何责任。</p>
				<p>6、用户明确并同意其使用夜夜快播网络服务所存在的风险将完全由其本人承担；因其使用夜夜快播网络服务而产生的一切后果也由其本人承担，夜夜快播对此不承担任何责任。</p>
				<p>7、除夜夜快播注明之服务条款外，其它因不当使用本站而导致的任何意外、疏忽、合约毁坏、诽谤、版权或其他知识产权侵犯及其所造成的任何损失，夜夜快播概不负责，亦不承担任何法律责任。</p>
				<p>8、对于因不可抗力或因黑客攻击、通讯线路中断等夜夜快播不能控制的原因造成的网络服务中断或其他缺陷，导致用户不能正常使用夜夜快播，夜夜快播不承担任何责任，但将尽力减少因此给用户造成的损失或影响。</p>
				<p>9、本声明未涉及的问题请参见国家有关法律法规，当本声明与国家有关法律法规冲突时，以国家法律法规为准。</p>
				<p>10、本网站相关声明版权及其修改权、更新权和最终解释权均属夜夜快播所有。</p>
			</details>
			<h3>使用帮助</h3>
