<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>    
 <input type="hidden"  name="CHANNEL_NO"  id="CHANNEL_NO" value="${pd.CHANNEL_NO}" /> 
	...
	<script src="static/js/v5/zepto.min.js"></script>
	<script src="static/js/v5/frozen.js"></script>
	<script src="static/js/v5/vue.min.js"></script>
	<script src="static/js/v5/common.min.js"></script>
