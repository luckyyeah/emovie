...
<html lang="en">
    ...
    <head>
        ...
        <title>会员中心</title>
                <link rel="stylesheet" href="http://kou.hyxxzzc.com/public/new_wap/css/swiper-3.3.1.min.css">
        <link rel="stylesheet" href="http://kou.hyxxzzc.com/public/new_wap/css/style.css">
        <link rel="stylesheet" href="http://kou.hyxxzzc.com/public/new_wap/css/grid.css">
        <script src="http://kou.hyxxzzc.com/public/new_wap/js/flexible_0.3.4.js" type="text/javascript" charset="utf-8"></script>
        ...
        $(".userActive").click(function (e) {
            ...
            if ( orderNo == '') {
                ...
                return false;
								...
								var url = "<%=basePath%>wapmovie/checkOrderPayed?orderNo=" + orderNo +"&uid="+getCookie("uid")+ "&tm="+new Date().getTime();
