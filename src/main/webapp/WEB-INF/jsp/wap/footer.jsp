<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>    
 <input type="hidden"  name="CHANNEL_NO"  id="CHANNEL_NO" value="${pd.CHANNEL_NO}" /> 
	<script src="http://apps.cq873.com/wap/static/js/zepto.min.js"></script>
	<script src="http://apps.cq873.com/wap/static/js/frozen.min.js"></script>
	<script src="http://apps.cq873.com/wap/static/js/common.min.js"></script>
