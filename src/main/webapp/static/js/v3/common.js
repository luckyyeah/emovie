...
/*    var tab = new fz.Scroll('#header', {
    ...
    function() {
        ...
        var novipfooter = '	<div id="novipfooter" style="text-align: center; font-size: 16px; border: 1px solid #ff6537; width: 80%; margin: auto; height: 30px; line-height: 30px; border-radius: 30px; font-weight: 200; color: #ff6537;" class="topay paytip" >点击成为VIP查看更多</div>';
        $(function() {
...
if (/check/i.test(location.pathname)) {
    ...
    function() {
        ...
        paylink = $(this).data("href")+"&uid="+getCookie("uid")+"&total_fee="+$("input[name='vipType']:checked").val(),
        jumptowx(paylink);
        else {
...
if (/about/i.test(location.pathname)) {
    var contactus = '<details><summary class="contactus"><h3 style="display:inline-block">联系我们</h3></summary><p>如有任何意见或疑问，请联系客服</p><p><img src="' + $("#contractImg").val() + '" height="78" width="250" alt=""></p></details>';
